...
def build_user_prompt(
    ...
    return (
        ...
        f"ПОДВОПРОСЫ:\n{sub_list}\n\n"
        "Найди в фрагментах выше ВСЁ, что относится к вопросу и каждому подвопросу. "
        "Выпиши это близко к тексту учебника, организовав по подвопросам. "
        "Если по подвопросу ничего нет в фрагментах — напиши [нет в источниках]. "
